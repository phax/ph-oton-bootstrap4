                                         ...
                                         AbstractBootstrapWebPageForm <LoginInfo, WPECTYPE>
{
  ...
  protected static final boolean canLogoutUser (@NonNull final ISimpleWebExecutionContext aSWEC,
    ...
    for (final LoginInfo aLoginInfo : aLoginInfos)
    {
      ...
      if (canLogoutUser (aWPEC, aLoginInfo.getUser ()))
      {
        ...
        aActionCell.addChild (new HCA (aWPEC.getSelfHref ()
                                            ...
                                            .add (CPageParam.PARAM_OBJECT, aLoginInfo.getID ())).setTitle (
                                                                                                           EText.MSG_LOGOUT_USER.getDisplayTextWithArgs (aDisplayLocale,
                                                                                                                                                         sUserName))
